...
public class GlobalExceptionHandler {
	...
	public class UsuarioEdicaoException extends RuntimeException {
		private final Long usuarioId;
		private final UsuarioComEnderecoDTO usuarioComEnderecoDTO;

		public UsuarioEdicaoException(String message, Long usuarioId, UsuarioComEnderecoDTO dto, Throwable cause) {
			super(message, cause);
			this.usuarioId = usuarioId;
			this.usuarioComEnderecoDTO = dto;
		}
		...
		public UsuarioComEnderecoDTO getUsuarioComEnderecoDTO() {
			return usuarioComEnderecoDTO;
		}
	}
}